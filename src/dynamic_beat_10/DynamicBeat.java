...
public class DynamicBeat extends JFrame {
	...
	public void screenDraw(Graphics2D g) { //그래픽을 입히는부분
		...
		if(isGameScreen) {//게임디자인화면이 true가 됬을때
			g.drawImage(noteRouteImage, 360, 30, null);
			g.drawImage(noteRouteImage, 516, 30, null);
			g.drawImage(noteRouteImage, 672, 30, null);
			g.drawImage(noteRouteImage, 828, 30, null);
			g.drawImage(noteRouteImage, 978, 30, null);
			g.drawImage(noteRouteImage, 1134, 30, null);
			g.drawImage(noteRouteImage, 1290, 30, null);
			g.drawImage(noteRouteImage, 1446, 30, null);
